...
from .reclamaciones_models import  Reclamacion, Defecto, Categoria, Ocurrencia, TipoDeReclamacion, EstatusReclamacion
from .tickect_models import Ticket, Color_Ticket, Area, Estatus_Ticket
from .liberaciones_models import Liberacion, EstatusLiberacion
