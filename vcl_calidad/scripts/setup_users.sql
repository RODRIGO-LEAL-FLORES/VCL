-- Archivo: scripts/setup_users.sql
-- Añade la columna `puede_gestionar_usuarios` y crea/actualiza los usuarios solicitados.
-- Ejecutar con psql: psql "${DATABASE_URL}" -f scripts/setup_users.sql
...
-- 3) Insertar o actualizar al usuario 'luis'
...
-- 4) Insertar o actualizar al usuario admin@vclaminations.com con permisos de gestión de usuarios
INSERT INTO usuarios (
  nombre, email, password, rol_id, activo,
  puede_ver_reclamaciones, puede_ver_tickets, puede_ver_reportes, puede_gestionar_usuarios
)
